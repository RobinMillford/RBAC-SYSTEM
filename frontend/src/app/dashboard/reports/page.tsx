    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <div className="p-2 rounded-xl" style={{ background: '#fffbeb' }}>
          <BarChart2 style={{ color: '#f59e0b' }} size={22} />
        </div>
        <div>
          <h1 className="text-xl font-bold text-stone-900">Reports</h1>
          <p className="text-sm text-stone-400">Analytics and business reports</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-stone-400 mt-1">The reports module is under construction.</p>
        </div>
      </div>
    </div>
  );
